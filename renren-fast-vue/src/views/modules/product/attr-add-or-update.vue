    ...
    >
      ...
      >
        <el-input
          ...
          placeholder="值类型[0-为单个值，1-可以选择多个值]"
        ></el-input>
      </el-form-item>
      ...
      >
        <el-input
          ...
          placeholder="快速展示【是否展示在介绍上；0-否 1-是】，在sku中仍然可以调整"
        ></el-input>
      </el-form-item>
    </el-form>
    ...
    return {
      ...
      dataRule: {
        ...
        valueType: [
          {
            required: true,
            message: "值类型[0-为单个值，1-可以选择多个值]不能为空",
            trigger: "blur",
          },
        ],
        icon: [
        ...
        attrType: [
          {
            required: true,
            message: "属性类型[0-销售属性，1-基本属性不能为空",
            trigger: "blur",
          },
        ],
        enable: [
